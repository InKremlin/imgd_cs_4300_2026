...
- Create an interactive piece that runs in a HTML page hosted at site of your choosing (GitHub Pages is fine for this, you could also consider something
- like [codepen](https://codepen.io)). The best starting point for this assignment is probably the
- [video feedback howto from gulls](https://codeberg.org/charlieroberts/gulls/howtos/9_video_feedback). The piece should feature a fullscreen fragment
